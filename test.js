...
gen.nodes.push(new NodeGene('INPUT', 1, 0))
gen.nodes.push(new NodeGene('INPUT', 2, 0))
gen.nodes.push(new NodeGene('INPUT', 3, 0))
gen.nodes.push(new NodeGene('HIDDEN', 5, 0))
gen.nodes.push(new NodeGene('OUTPUT', 4, 0))
